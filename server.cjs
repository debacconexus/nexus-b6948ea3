...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Border-Zone Counter-Trafficking & Aid Distribution Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Border-Zone Counter-Trafficking & Aid Distribution Taskforce (NGO / INTERPOL / UNHCR)";
process.env.TABLE_NAME = process.env.TABLE_NAME || "border_zone_counter_trafficking___aid_distribution_taskforce__ngo___interpol___unhcr__records";
'use strict';
